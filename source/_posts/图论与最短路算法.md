...
tags: [OJ, haizeiOJ, 图论, 最短路算法, 动态规划, 贪心算法]
---
...
![image-20210225185917091](https://hauk-blog.oss-cn-hangzhou.aliyuncs.com/blogimage-20210225185917091.png)
...
Djikstra 算法是单源最短路径算法：每次找到一个距离起点最近的未访问点，并根据该点更新起点到其他点的距离，然后标记该点访问过，并认为到该点的最短距离确定，可认为这是一种贪心算法。该算法不允许边上存在负权。时间复杂度为 $O(n^2)$ ，$n$ 为点的数量。
